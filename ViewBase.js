define(["dcl/dcl", "require", "dojo/when", "dojo/on", "dojo/dom-attr", "dojo/dom-style", "dojo/_base/declare",
	"dojo/_base/lang", "dojo/Deferred", "./utils/constraints"],
	function (dcl, require, when, on, domAttr, domStyle, declare, lang, Deferred, constraints) {
		return declare(null, {
			// summary:
