define(["dcl/dcl", "dojo/_base/lang", "dijit/registry", "dojo/dom-attr", "dojo/dom-geometry",
	"dojo/dom-style", "dijit/_WidgetBase", "dijit/_Container", "dijit/_Contained", "dojo/_base/array", "dojo/query",
	"../utils/layout", "./_ScrollableMixin"],
	function (dcl, lang, registry, domAttr, domGeom, domStyle, WidgetBase, Container, Contained, array, query,
		layoutUtils, ScrollableMixin) {
		return dcl([WidgetBase, Container, Contained, ScrollableMixin], {
			scrollable: false,
			fixedFooter: "",
			fixedHeader: "",
			...
			resize: dcl.superCall(function (sup) {
			    return function (changeSize, resultSize) {
					// summary:
					...
					if (this.scrollable) {
						//this.inherited(arguments);
						sup.call(this, changeSize, resultSize);
						this.layout();
						return;
					}
