	...
	function (declare, lang, array, win, domClass, registry, dom, domConstruct, Scrollable) {
		...
		return declare(Scrollable, {
			...
			constructor: function () {
				// set noResize to true to match the way it was done in app/widgets/scrollable.js
			...
			buildRendering: function () {
				...
				this.containerNode =
					domConstruct.create("div", {className: "mblScrollableViewContainer"}, this.domNode);
