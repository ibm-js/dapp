define(["dojo/_base/declare", "dojo/_base/lang", "dojo/_base/array", "dojo/_base/window",
	...
	function (declare, lang, array, win, query, domGeom, domAttr, domStyle, registry, LayoutBase, layout,
		constraints) {
		// module:
		...
		return declare(LayoutBase, {
			...
			_doResize: function (view) {
				...
				if (!node) {
					this.app.log("Warning - View has not been loaded, in Layout _doResize view.domNode is not set " +
						"for view.id=" + view.id + " view=", view);
					return;
				}
